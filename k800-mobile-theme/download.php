...
<html>
  ...
  <title>K800 Themes Download</title>
  <link rel="stylesheet" href="css/k800style.css" media="screen" />
  </head>
  <body>
  	<p>Sorry! But you can only download each theme twice in a single hour. Please come back later and try again. <a href="http://www.inneroptics.com/k800-mobile-theme">Back to Theme page</a></p>
  </body>
</html>
  ...
  if (is_file($dlDir . $file)) {
    ...
    if ($exists == 0) {
      $query = "INSERT INTO $filenameTable (filename,filetype) VALUES ('$file','1')";
...
<html>
  ...
  <body>
    <p>Thank you for downloading, click <a href="http://www.inneroptics.com/k800-mobile-theme">here</a> to return.</p>
  </body>
</html>
